...
function access_staffing_jax_scripts() {
    ...
    wp_enqueue_script( 'access-staffing-jax-jquery', get_template_directory_uri() . '/js/jquery.min.js', array(), '', true);
	...
	wp_enqueue_script( 'access-staffing-jax-tether', get_template_directory_uri() . '/js/tether.min.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-smoothscroll', get_template_directory_uri() . '/js/smooth-scroll.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-touch', get_template_directory_uri() . '/js/jquery.touch-swipe.min.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-viewport', get_template_directory_uri() . '/js/jquery.viewportchecker.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-jarallax', get_template_directory_uri() . '/js/jarallax.min.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-scriptmin', get_template_directory_uri() . '/js/script.min.js', array(), '', true);
	wp_enqueue_script( 'access-staffing-jax-script', get_template_directory_uri() . '/js/script.js', array(), '', true);
